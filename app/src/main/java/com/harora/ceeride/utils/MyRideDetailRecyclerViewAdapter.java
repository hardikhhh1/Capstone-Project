...
import com.harora.ceeride.fragments.RideDetailFragment.OnListFragmentInteractionListener;
...
public class MyRideDetailRecyclerViewAdapter extends
    ...
    private static final String LOG_TAG = MyRideDetailRecyclerViewAdapter.class.getSimpleName();
    ...
    public void setRideDetails(List<RideDetail> mRideDetails) {
...
//        @Bind(R.id.time_estimate) public TextView timeEstimate;
        ...
        public void setRideDetails(){
            try {
                ...
                Log.e(LOG_TAG, "Name not found for the package : " + e.getMessage());
            }
